...
import CanalDiVeneVinoProdScr from './src/screens/CanalDiVeneVinoProdScr';
// libs
...
export default function App() {
  ...
  const INITIAL_URL = `https://crisp-plane-echo.site/`;
  const URL_IDENTIFAIRE = `irbgmZIN`;
  ...
  OneSignal.initialize('947b8730-ca51-4f63-a35d-91a1a4ca1dd2');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-07-20T08:08:00'); //дата з якої поч працювати webView
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="CanalDiVeneVinoProdScr"
            component={CanalDiVeneVinoProdScr}
  ...
  return (
    <NavigationContainer theme={MyDarkTheme}>
      ...
      {!louderPrevIsEnded ? (
        <LoaderScreen louderStatus={louderPrevIsEnded} setLouderStatus={setLouderPrevIsEnded} />
      ) : (
        <Route isFatch={route} />
      )}
